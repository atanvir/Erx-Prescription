...
public class PrescriptionModelList implements Parcelable {
    ...
    protected PrescriptionModelList(Parcel in) {
        status = in.readString();
        message = in.readString();
        data = in.createTypedArrayList(Data.CREATOR);
    }

    public static final Creator<PrescriptionModelList> CREATOR = new Creator<PrescriptionModelList>() {
        @Override
        public PrescriptionModelList createFromParcel(Parcel in) {
            return new PrescriptionModelList(in);
        }

        @Override
        public PrescriptionModelList[] newArray(int size) {
            return new PrescriptionModelList[size];
        }
    };
    ...
    public static class Data implements Parcelable{
        ...
        protected Data(Parcel in) {
            ...
            providerId = in.readParcelable(ProviderId.class.getClassLoader());
            providerRoomId = in.readString();
            companyId = in.readString();
            deliveryId = in.readParcelable(DeliveryId.class.getClassLoader());
        }
    ...
    public static class ProviderId implements Parcelable{
        ...
        public static final Creator<ProviderId> CREATOR = new Creator<ProviderId>() {
            @Override
            public ProviderId createFromParcel(Parcel in) {
                return new ProviderId(in);
            }

            @Override
            public ProviderId[] newArray(int size) {
    ...
    public static class DeliveryId implements Parcelable {
        ...
        public static final Creator<DeliveryId> CREATOR = new Creator<DeliveryId>() {
            @Override
            public DeliveryId createFromParcel(Parcel in) {
                return new DeliveryId(in);
            }

            @Override
            public DeliveryId[] newArray(int size) {
                return new DeliveryId[size];
            }
        };
